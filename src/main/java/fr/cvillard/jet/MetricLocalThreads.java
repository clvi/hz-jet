...
public class MetricLocalThreads {
	...
	public static void main(String[] args) throws ExecutionException, InterruptedException {
		...
		ILogger logger = hzInstance.getLoggingService().getLogger(MetricLocalThreads.class);
		...
		// create a distributed executor, which enrich & put to output maps entries of local nodes
